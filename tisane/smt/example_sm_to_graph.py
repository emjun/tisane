...
# interactions = pair((first tutoring), (second intelligence))
interactions = EmptySet(Object)
...
ixn_facts = [
    Models(sat_score, main_effects), 
    Dependent(sat_score),
    Cause(tutoring, intelligence), # Add both for each main effect and require end-user to pick one
