    ...
    def start_app(self, input: str):
        ...
        progress_row = [
            dbc.Col(dbc.Progress(
                [
                    dbc.Progress("Look over main effects",
                                 value=25,
                                 animated=True,
                                 striped=True,
                                 bar=True,
                                 id="main-effects-progress"),
                    dbc.Progress("Look over interaction effects",
                                 value=25,
                                 animated=False,
                                 bar=True,
                                 id="interaction-effects-progress",
                                 color="secondary"),
                    dbc.Progress("Look over random effects",
                                 value=25,
                                 animated=False,
                                 bar=True,
                    ...
                    dbc.Progress("Pick family and link functions",
                                 value=25,
                                 animated=False,
                                 bar=True,
    ...
    def model_tabs(self):
        ...
        tabs = dbc.Tabs(
            [
                ...
                dbc.Tab(tab3_content, label="Random effects", tab_style={"marginLeft": "auto"},
                        tab_id="tab-3",
                        id="random-effects-tab"),
                dbc.Tab(tab4_content, label="Family, Link functions", tab_style={"marginLeft": "auto"},
                        tab_id="tab-4",
