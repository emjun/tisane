...
class Design(object): 
    ...
    def __init__(self, ivs: List[AbstractVariable], dv: AbstractVariable, unit: AbstractVariable): 
        self.ivs = ivs 
        self.dv: = dv
        self.unit = unit
    ...
    def measure(self, unit: AbstractVariable, measure: AbstractVariable, times: int): 
        pass
