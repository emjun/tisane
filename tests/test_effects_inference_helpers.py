...
class EffectsInferenceHelpersTest(unittest.TestCase):
    ...
    def test_find_common_causal_ancestors(self):
        ...
        self.assertEqual(len(common_ancestors_variables), 1)
        self.assertIn(m0, common_ancestors_variables)
    ...
    def test_find_all_causal_ancestors(self):
        ...
        self.assertEqual(len(causal_ancestors_variables), 2)
        self.assertIn(m0, causal_ancestors_variables)
        self.assertIn(m1, causal_ancestors_variables)
    ...
    def test_find_all_causal_ancestors_partial_graph(self):
        ...
        self.assertEqual(len(causal_ancestors_variables), 1)
    ...
    def test_find_all_associates_that_causes_or_associates_with_dv(self):
        ...
        self.assertIn(m2, associates_that_cause_dv_variables)
    ...
    def test_find_all_associates_that_causes_or_associates_with_dv_is_not_recursive(
        ...
        self.assertIn(m0, associates_that_cause_dv_variables)
        self.assertIn(m1, associates_that_cause_dv_variables)
        self.assertNotIn(m2, associates_that_cause_dv_variables)
    ...
    def test_find_moderates_on_dv_interaction_order_agnostic(self):
        ...
        m0.moderates(
            moderator=[m1], on=dv
        )  # Checks that ts.Design with ivs = m1 also returns same (flips above)
    ...
    def test_filter_interactions_involving_variables_multiple_interactions_all_included(
        self,
    ):
        u0 = ts.Unit("Unit")
        m0 = u0.numeric("Measure_0")
    ...
    def test_construct_random_effects_for_repeated_measures_no_nesting(self):
        ...
        random_effects = construct_random_effects_for_repeated_measures(
            gr=gr, query=design
        )
    ...
    def test_construct_random_effects_does_not_construct(self):
        ...
        random_from_repeats = construct_random_effects_for_repeated_measures(
            gr=gr, query=design
        )
    ...
    def test_construct_random_effects_for_nests_none_one_unit(self):
        ...
        random_from_nests = construct_random_effects_for_nests(
            gr=gr, dv=design.dv, variables=design.ivs
        )
    ...
    def test_construct_random_effects_for_nests_for_two_units_excludes_lower_unit(self):
        ...
        random_effects = construct_random_effects_for_nests(
            gr=gr, dv=design.dv, variables=design.ivs
        )
        self.assertEqual(
            len(random_effects), 0
        )  # There are no random effects because this analysis is focused on u0 main effects

    def test_construct_random_effects_for_nests_two_units_no_measures_for_higher_unit(
        self,
    ):
        u0 = ts.Unit("Unit 0")
        u1 = ts.Unit("Unit 1")
    ...
    def test_construct_random_effects_for_nests_for_three_units_measures_for_lower_two(
        self,
    ):
    ...
    def test_construct_random_effects_for_composed_measures_between_items_within_participants_repeats(
        self,
    ):
        ...
        random_effects = construct_random_effects_for_composed_measures(
    ...
    def test_construct_random_effects_for_composed_measures_between_items_within_participants_no_repeats(
        self,
    ):
        subject = ts.Unit("Subject")
    ...
    def test_find_largest_subset_of_variables_that_vary_within_unit_two_way_one_within(
        self,
    ):
        u = ts.Unit("Unit")
    ...
    def test_find_largest_subset_of_variables_that_vary_within_unit_two_way_two_within(
        self,
    ):
        u = ts.Unit("Unit")
        a = u.nominal(
    ...
    def test_find_largest_subset_of_variables_that_vary_within_unit_three_way_two_within_one_between(
        self,
    ):
        u = ts.Unit("Unit")
        a = u.nominal("Measure A", cardinality=2)  # A is between-subjects
