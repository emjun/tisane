...
class KnowledgeBaseTests(unittest.TestCase): 
    ...
    def test_effect_set_format_assertions(self):
        ...
        res = format_effect_set_constraint(effect_set=linear_reg_es, key='tolerate_correlation', val=True)
        if res == DataForTests.expected_tolerate_constraint_intelligence_first: 
            self.assertNotEqual(res, DataForTests.expected_tolerate_constraint_tutoring_first)
        else: 
            self.assertNotEqual(res, DataForTests.expected_tolerate_constraint_intelligence_first)
            self.assertEqual(res, DataForTests.expected_tolerate_constraint_tutoring_first)
        self.assertEqual(len([format_effect_set_constraint(effect_set=linear_reg_es, key='tolerate_correlation', val=True)]), 1)
...
class DataForTests: 
    ...
    expected_tolerate_constraint_intelligence_first = "tolerate_correlation(intelligence,tutoring)."
    expected_tolerate_constraint_tutoring_first = "tolerate_correlation(tutoring,intelligence)."
