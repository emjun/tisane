...
from os import link
from tisane.family import BinomialFamily, GammaFamily, GaussianFamily, IdentityLink, InverseGaussianFamily, MultinomialFamily, NegativeBinomialFamily, PoissonFamily, TweedieFamily, IdentityLink, InverseLink, InverseSquaredLink, LogLink, LogitLink, ProbitLink, CLogLogLink, PowerLink, OPowerLink, NegativeBinomialLink, LogLogLink
import tisane as ts
...
from tisane.statistical_model_inference import generate_family_functions, generate_link_functions
import unittest
...
class DataForTests: 
    ...
    binomial_links = [IdentityLink, LogLink, LogitLink, ProbitLink, CLogLogLink, PowerLink, OPowerLink, LogLogLink]
