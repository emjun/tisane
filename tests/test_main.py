...
class TestDriver(unittest.TestCase): 
    def testMultiverseGeneration(self): 
        dir = os.path.relpath("examples/Animal_Science/")
    ...
    def test_multiverse_decisions_generation(self): 
        file = "decisions.json"
        pass

    def test_multiverse_template_generation(self): 
        file = "template.py"
        pass
